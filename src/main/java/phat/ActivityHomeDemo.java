 ...
 * @author UCM
 */
public class ActivityHomeDemo implements PHATInitAppListener {

    private static final Logger logger = Logger.getLogger(ActivityHomeDemo.class.getName());
    ...
    public static void main(String[] args) {
        ActivityHomeDemo app = new ActivityHomeDemo();
